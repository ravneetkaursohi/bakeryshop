    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <?php
                $count = 0;
                $select = "select * from bill where status='pending'";
                ...
                while ($row = mysqli_fetch_array($res)) {
                    ...
                    <tr class="text-center">
                        ...
                        <td><a href="dispatch_order.php?q=<?php echo $row[0] ?>">Dispatch</a></td>
                    </tr>
                    <tr>
                        <th colspan="7" class="text-center">List of Products</th>
                    </tr>
                    <tr>
                        <th colspan="7">
                            <div class="row">
